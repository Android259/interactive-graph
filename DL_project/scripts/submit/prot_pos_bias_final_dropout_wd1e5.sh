...
mkdir -p script_logs/prot_pos_bias_final_dropout_wd1e5
...
submit_variant() {
    ...
    local output_dir="script_logs/prot_pos_bias_final_dropout_wd1e5/${group}"
    ...
    oarsub \
        --name "pbfd_${group}_${variant}_s${seed}" \
...
printf 'Submitted 36 final-dropout jobs with weight_decay=1e-5 across all 9 groups and seeds 0/1.\n'
