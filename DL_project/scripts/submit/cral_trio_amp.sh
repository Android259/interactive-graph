...
mkdir -p script_logs/cral_trio_amp
...
submit_variant() {
    ...
    shift 3
    local extra_flags=("$@")
    local output_dir="script_logs/cral_trio_amp/${group}"
...
groups=("CRAL-TRIO")
variants=(
    "pos_bias_lr3e4_fp32|0.0003|--no_tanimoto_weight --protein_pooling=attention_pos_bias"
)
...
printf 'Submitted 1 CRAL-TRIO AMP job.\n'
