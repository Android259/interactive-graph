...
mkdir -p script_logs/prot_pos_bias_bidirectional_edges_standard_seeds01234

submit_variant() {
    local group="$1"
    local seed="$2"
    local variant="bidir_edges_standard"
    local output_dir="script_logs/prot_pos_bias_bidirectional_edges_standard_seeds01234/${group}"
...
printf 'Submitted 45 bidirectional-edge standard jobs across all 9 groups and seeds 0/1/2/3/4.\n'
