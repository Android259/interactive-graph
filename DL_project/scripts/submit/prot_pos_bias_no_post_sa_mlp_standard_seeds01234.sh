...
mkdir -p script_logs/prot_pos_bias_no_post_sa_mlp_standard_seeds01234

submit_variant() {
    local group="$1"
    local seed="$2"
    local variant="no_post_sa_mlp_standard"
    local output_dir="script_logs/prot_pos_bias_no_post_sa_mlp_standard_seeds01234/${group}"
...
printf 'Submitted 45 standard no-post-SA-MLP jobs across all 9 groups and seeds 0-4.\n'
