...
mkdir -p script_logs/rerun_bad_weight_decay_jobs
...
submit_variant() {
    ...
    local output_dir="script_logs/rerun_bad_weight_decay_jobs/${group}"
    ...
    oarsub \
        --name "pbwdr_${group}_${variant}_s${seed}" \
...
jobs=(
    "CRAL-TRIO|0|wd1e5|0.00001"
    "CRAL-TRIO|0|wd1e4|0.0001"
    "CRAL-TRIO|1|wd1e5|0.00001"
    "CRAL-TRIO|1|wd1e4|0.0001"
    "GLTP|0|wd1e5|0.00001"
    "GLTP|0|wd1e4|0.0001"
    "IP_trans|0|wd1e5|0.00001"
    "IP_trans|0|wd1e4|0.0001"
    "IP_trans|1|wd1e5|0.00001"
    "IP_trans|1|wd1e4|0.0001"
    "START|0|wd1e5|0.00001"
    "START|0|wd1e4|0.0001"
    "START|1|wd1e5|0.00001"
    "START|1|wd1e4|0.0001"
    "lipocalin|0|wd1e5|0.00001"
    "lipocalin|0|wd1e4|0.0001"
    "lipocalin|1|wd1e5|0.00001"
    "lipocalin|1|wd1e4|0.0001"
)

for specification in "${jobs[@]}"; do
    IFS="|" read -r group seed variant weight_decay <<< "${specification}"
    submit_variant "${group}" "${seed}" "${variant}" "${weight_decay}"
done

printf 'Submitted 18 reruns for collided or incomplete weight-decay jobs.\n'
