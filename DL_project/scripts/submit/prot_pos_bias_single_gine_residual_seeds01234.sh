...
mkdir -p script_logs/prot_pos_bias_single_gine_residual_seeds01234

submit_variant() {
    local group="$1"
    local seed="$2"
    local variant="single_gine_residual"
    local output_dir="script_logs/prot_pos_bias_single_gine_residual_seeds01234/${group}"
...
printf 'Submitted 45 single-GINE-residual jobs across all 9 groups and seeds 0-4.\n'
