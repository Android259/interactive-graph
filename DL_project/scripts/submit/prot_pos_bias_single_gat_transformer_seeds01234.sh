...
mkdir -p script_logs/prot_pos_bias_single_gat_transformer_seeds01234

submit_variant() {
    local group="$1"
    local seed="$2"
    local variant="single_gat_transformer"
    local output_dir="script_logs/prot_pos_bias_single_gat_transformer_seeds01234/${group}"
...
printf 'Submitted 45 single-GAT TransformerConv jobs across all 9 groups and seeds 0-4.\n'
