...
mkdir -p script_logs/prot_pos_bias_standard_lipid_isomers_seeds01234

submit_variant() {
    local group="$1"
    local seed="$2"
    local variant="standard_lipid_isomers"
    local output_dir="script_logs/prot_pos_bias_standard_lipid_isomers_seeds01234/${group}"
...
printf 'Submitted 45 standard lipid-isomer jobs across all 9 groups and seeds 0-4.\n'
