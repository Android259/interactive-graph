# DeepCLIP, lipid-isolation point within CRAL-TRIO (cral-trio__0.80). Fills in the Tanimoto-similarity-vs-metric curve
...
# --lipid_isolation=cral-trio__0.80 -- a species set chosen for CRAL-TRIO's own panel -- against
...
#
# --lipid_isolation=cral-trio__0.80 holds 69 lipid species out of training for CRAL-TRIO
...
# isolation 0.800 -- the GLOBAL blocks calibrated against the whole table do not
...
# --family_only value).
#
# Composition: phosphatidylcholine, 100%. a named chemistry: exactly the phosphatidylcholines of CRAL-TRIO's own panel. Reconstructed at seeds 0-4 with this file's own
# sampler (18 positives on the full table): test block 27 rows, 9 positives at every seed. Isolation is
...
--lipid_isolation=cral-trio__0.80
