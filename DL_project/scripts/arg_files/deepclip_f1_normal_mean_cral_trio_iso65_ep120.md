# DeepCLIP, lipid-isolation point within CRAL-TRIO (cral-trio__0.65). Fills in the Tanimoto-similarity-vs-metric curve
...
# --lipid_isolation=cral-trio__0.65 -- a species set chosen for CRAL-TRIO's own panel -- against
...
#
# --lipid_isolation=cral-trio__0.65 holds 133 lipid species out of training for CRAL-TRIO
...
# isolation 0.650 -- the GLOBAL blocks calibrated against the whole table do not
...
# --family_only value).
#
# Composition: phosphatidylcholine 56%, hexosyl ceramide 13%, sphingomyelin 13%, ceramide phosphate 8%, +2. fills the gap right above the floor. Reconstructed at seeds 0-4 with this file's own
...
--lipid_isolation=cral-trio__0.65
