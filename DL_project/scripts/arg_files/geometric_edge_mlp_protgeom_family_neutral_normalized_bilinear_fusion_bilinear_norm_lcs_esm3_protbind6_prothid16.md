...
# bilinear_norm_lcs_protbind6_prothid16.md -- see that file's own header for the
# --protein_hiddim=16 reasoning and the known protein-side-width memorisation risk
